                    ...
                    <div class="flex flex-col gap-y-10">
                        ...
                        <div>
                            @if ($subscribeTransaction->is_paid)
                                <span
                                    class="text-sm font-bold py-2 px-3 rounded-full bg-green-500 text-white">Paid</span>
                            @else
                                <span
                                    class="text-sm font-bold py-2 px-3 rounded-full bg-orange-500 text-white">Pending</span>
                            @endif
                        </div>
                        <div>
