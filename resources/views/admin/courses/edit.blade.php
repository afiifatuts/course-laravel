            ...
            <div class="bg-white overflow-hidden p-10 shadow-sm sm:rounded-lg">
                ...
                <form method="POST" action="{{route('admin.courses.update',$course)}}" enctype="multipart/form-data">
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="thumbnail" class="block mt-1 w-full" type="file" name="thumbnail" autofocus autocomplete="thumbnail" value="{{$course->thumbnail}}" />
                    ...
                    <div class="mt-4">
                        ...
                        <div class="flex flex-col gap-y-5">
                            ...
                            @forelse ($course->course_keypoints as $keypoint)                                
                                <input type="text" class="py-3 rounded-lg border-slate-300 border" placeholder="Write your copywriting" value="{{$keypoint->name}}" name="course_keypoints[]">
                            @empty
